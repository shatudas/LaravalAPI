        ...
        <form method="POST" action="{{route('product.update',$editdata->id)}}" id="myForm" enctype="multipart/form-data">
         ...
         <div class="form-row">
          ...
          <div class="form-group col-md-6">
           ...
           <input type="text" name="price" value="{{ $editdata->price }}" class="form-control">
          ...
          <div class="form-group col-md-3">
           ...
           <div class="form-group col-md-3">
            <img id="showImage" src="{{ url('upload/product_image/'.$editdata->image) }}" style=" height:60px; width:60px; margin-top:15px; border:1px solid #ccc; float:right;">
           </div>
